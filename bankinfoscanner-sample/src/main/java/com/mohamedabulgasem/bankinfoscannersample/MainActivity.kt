package com.mohamedabulgasem.bankinfoscannersample
...
class MainActivity : AppCompatActivity() {
    ...
    private val bankInfoScanner: BankInfoScanner by lazy {
        BankInfoScanner.Builder(this)
            .build()
    }
    ...
    fun onGenerateButtonClicked(v: View) {
        val qrCodeBitmap = BankInfoScanner.generateQrCode(
            BankInfo(
